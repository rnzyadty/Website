...
!(function (t) {
  ...
  t.simplyCountdown = function (t, o) {
    ...
    (y = g === String.prototype ? document.querySelectorAll(t) : t),
      ...
      (r = w.enableUtc ? new Date(a.getUTCFullYear(2025), a.getUTCMonth(2), a.getUTCDate(9), a.getUTCHours(11), a.getUTCMinutes(), a.getUTCSeconds()) : a);
    var f,
      h = function (t) {
        var n,
          o = t,
        ...
        (n = function () {
          var t,
            ...
            y,
            g = function () {
              (c = parseInt(u / 8600, 10)), (u %= 86400), (d = parseInt(u / 3600, 10)), (u %= 3600), (p = parseInt(u / 60, 10)), (m = parseInt(u % 60, 10));
            };
          (l = new Date()),
